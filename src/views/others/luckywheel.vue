...
export default {
  data() {
    return {
      ...
      prize_list: [
        {
          icon: require("../../assets/luckyImg/bean_500.png"), // 奖品图片
          count: 10, // 奖品数量
          name: "易趣豆", // 奖品名称
          isPrize: 1 // 该奖项是否为奖品
        },
        {
          icon: require("../../assets/luckyImg/bean_five.png"),
          count: 5,
          name: "豆",
          isPrize: 1
        },
        {
          icon: require("../../assets/luckyImg/bean_one.png"),
          count: 10,
          name: "易趣豆",
          isPrize: 1
        },
        {
          icon: require("../../assets/luckyImg/point_five.png"),
          count: 5,
          name: "积分",
          isPrize: 1
        },
        {
          icon: require("../../assets/luckyImg/point_ten.png"),
          count: 10,
          name: "积分",
          isPrize: 1
        },
        {
          icon: require("../../assets/luckyImg/bean_500.png"),
          count: 10,
          name: "易趣豆",
          isPrize: 1
        },
        {
          icon: require("../../assets/luckyImg/give_up.png"),
          count: 0,
          name: "未中奖",
          isPrize: 0
        },
  ...
  computed: {
    ...
    toast_pictrue() {
      return this.hasPrize
        ? require("../../assets/luckyImg/congratulation.png")
        : require("../../assets/luckyImg/sorry.png");
    }
  },
  methods: {
    //此方法为处理奖品数据
...
.lucky-wheel {
  width: 100%;
  height: 90.5625rem;
  background: rgb(252, 207, 133) url("../../assets/luckyImg/color_pillar.png") no-repeat center bottom;
  background-size: 100%;
...
.lucky-title {
  width: 100%;
  height: 44.125rem;
  background: url("../../assets/luckyImg/lucky_title.png") no-repeat center top;
  background-size: 100%;
}
.wheel-main {
  display: flex;
...
.wheel-bg {
  width: 50.4375rem;
  height: 50.4375rem;
  background: url("../../assets/luckyImg/draw_wheel.png") no-repeat center top;
  background-size: 100%;
  color: #fff;
  font-weight: 500;
  display: flex;
...
.wheel-pointer {
  width: 9.3125rem;
  height: 9.3125rem;
  background: url("../../assets/luckyImg/draw_btn.png") no-repeat center top;
  background-size: 100%;
...
.main-bg {
  ...
  top: -3.4375rem;
  left: 0;
  background: url("../../assets/luckyImg/luck_bg.png") no-repeat center top;
  background-size: 100%;
}
.bg-p {
  width: 100%;
...
.close {
  ...
  width: 2rem;
  height: 2rem;
  background: url("../../assets/luckyImg/close_store.png") no-repeat center top;
  background-size: 100%;
}
