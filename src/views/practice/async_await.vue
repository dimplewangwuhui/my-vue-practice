<template>
    <div style="padding: 20px; background-color: #fff">
        ...
        <el-button @click="setTimeout1_1">传统异步1</el-button><span>setTimeout被调用的时候，主线程不会等待1秒，而是先执行别的任务</span><br>
        <el-button @click="setTimeout1_2">传统异步2</el-button><br>
        <el-button @click="setTimeout2">promise异步</el-button><br>
        <el-button @click="setTimeout3_1">async异步1</el-button><br>
        <el-button @click="setTimeout3_2">async异步2</el-button><br>
        <div class="title">async的原型：</div>
        ...
        <div class="title">用Generator函数封装异步请求：</div>
